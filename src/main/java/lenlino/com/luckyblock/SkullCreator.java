...
public class SkullCreator {
	 ...
	 */
	public static ItemStack createSkull(int i) {
		checkLegacy();

		try {
			return new ItemStack(Material.valueOf("PLAYER_HEAD"), i);
		} catch (IllegalArgumentException e) {
			return new ItemStack(Material.valueOf("SKULL_ITEM"), i, (byte) 3);
		}
	}
	 ...
	 */
	public static ItemStack itemFromName(String name, Integer i) {
		return itemWithName(createSkull(i), name);
	}
	 ...
	 * @return The head of the Player.
	 */
	public static ItemStack itemFromBase64(String base64,Integer i) {
		return itemWithBase64(createSkull(i), base64);
	}
